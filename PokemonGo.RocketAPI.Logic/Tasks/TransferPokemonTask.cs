...
namespace PokemonGo.RocketAPI.Logic.Tasks
{
    public class TransferPokemonTask
    {
        public static async Task Execute()
        {
            ...
            var pokemonToTransfer = await Inventory.GetPokemonToTransfer(Logic._clientSettings.TransferPokemonKeepIfCanEvolve, Logic._clientSettings.PrioritizeIVOverCP, Logic._clientSettings.PokemonsToNotTransfer);
